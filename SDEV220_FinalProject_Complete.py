...
#by Cole Shane and Cheyanne Madara
#Purpose: Gather student and parent info for a k12 based organization
#output information to csv/json for easy archiving
...
#Student inherits from Person then adds attributes specific to student
...
#gathers parent details and concatenates together
...
#checks student data fields for content being present
